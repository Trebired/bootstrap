...
import { captureEventSink, captureLogger, tempDir, writeModule } from "#you8100fjr92";

function writeDeterministicModules(dir: string) {
...
function writeGroupedRuleModules(dir: string) {
